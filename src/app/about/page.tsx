  ...
  return (
    <div ref={containerRef} className="w-full px-6 sm:px-10 max-w-[1400px] mx-auto pt-40 pb-32">
      ...
      <div className="mb-24 lg:mb-32">
        <h1 className="font-sans font-bold text-5xl sm:text-7xl md:text-[5.5rem] tracking-tighter leading-[0.95] text-foreground" style={{ perspective: "1000px" }}>
          <span className="block about-heading-word origin-bottom">ENGINEERING</span>
          <span className="block about-heading-word origin-bottom text-muted">INTENTIONAL</span>
          <span className="block about-heading-word origin-bottom">INTERFACES.</span>
        </h1>
      </div>
        ...
        <div className="lg:col-span-7 flex flex-col gap-12">
          ...
          <div className="about-fade-in">
            ...
            <p className="text-xl sm:text-2xl leading-relaxed text-foreground text-balance">
              I am a full-stack developer based in Lagos, Nigeria. I specialize in building high-performance web applications that merge technical rigor with minimalist design.
            </p>
          </div>
          ...
          <div className="about-fade-in">
            ...
            <p className="text-base sm:text-lg leading-relaxed text-muted max-w-prose">
              My philosophy is rooted in simplicity. Whether I am constructing a complex authentication middleware or designing a landing page, I focus on stripping away the unnecessary. I build products that are fast, accessible, and feel effortless to use.
            </p>
            <p className="text-base sm:text-lg leading-relaxed text-muted max-w-prose mt-4">
              I view code as a medium for solving human problems. Performance matters. Accessibility matters. Design matters.
            </p>
          </div>
